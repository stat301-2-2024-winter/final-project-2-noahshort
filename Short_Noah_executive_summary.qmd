...
6 models were used: Null, Linear, Elastic net, K-Nearest Neighbors, Random Forest, and Boosted Trees
...
The the test results provide a couple of key takeaways for how I could improve the model in the future:
